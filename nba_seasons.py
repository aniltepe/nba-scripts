...
class Season:
    def __init__(self, name, startdate_rs, enddate_rs, startdate_po, enddate_po, startdate_f, enddate_f):
        self.name = name
...
seasons.append(Season("2019–20", datetime(2019, 10, 22).strftime("%Y-%m-%d"), datetime(2020, 8, 15).strftime("%Y-%m-%d"),
...
seasons.append(Season("2020–21", datetime(2020, 12, 22).strftime("%Y-%m-%d"), datetime(2021, 5, 21).strftime("%Y-%m-%d"),
